    ...
    def minimize(self):
        ...
        while classes!=uu:
            ...
            for clas in classes:
                ...
                if distinguishable!=set():
                    uu.append(distinguishable)
                if nondistinguishable!=set():
...
if __name__=="__main__":
    nfa=finiteAutomata()
    nfa.addTransaction(("0",0,"0"))
    nfa.addTransaction(("0",0,"1"))
    nfa.addTransaction(("1",0,"2"))
    nfa.addTransaction(("1",1,"2"))
    nfa.addTransaction(("2",1,"2"))
    nfa.addTransaction(("0",1,"1"))
